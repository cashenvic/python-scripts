...
def download_it():
    ...
    video.download()
    tk.Label(dock, text="Successfully Downloaded", font="arial 15").place(x=160, y=200)


# Download Button
tk.Button(dock, text="DOWNLOAD", font="Verdana 15 bold", bg="orange", padx=2, command=download_it).place(x=180, y=150)
